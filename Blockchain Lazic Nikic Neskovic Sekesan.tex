...
Zbog ovog problema neke blokčejn platforme poput Cardano (2017), Solana (2020) i Polkadot (2020) koriste ''proof of stake'' model koji troši dosta manje struje nego ''proof of work'' model.

\subsection{Akademska istraživanja}
Dosta univerziteta je zasnovalo odseke sa fokusom na istraživanju blokčejna i kriptovaluta, uključujući i MIT, koji je to uradio 2017. godine.

Između ostalog, istraživana je i uloga blokčejna u podržavanju saradnje između ljudi. \cite{teppo2018mitmenagmentrewiew} Zbog svoje transparentnosti, pouzdanosti i lako dostupnih zapisa, blokčejnovi podstiču saradjnu bolje od običnih ugovora i relacionih normi. Za razliku od ugovora, blokčejn ne zahteva pravni sistem da sprovede stavke ugovora i za razliku od relacionih normi, blokčejnu nije neophodno poverenje niti poznavanje između saradnika.

U septembru 2015. godine je najavljen prvi akademski žurnal posvećen blokčejnu i kriptovalutama, \emph{Ledger}. Prvo izdanje je objavljeno decembra 2016. godine. Taj žurnal se fokusirao na matematiku, informatiku, inžinjerstvo, pravo, ekonomiju i filozofiju vezanu sa kriptovalutama.
